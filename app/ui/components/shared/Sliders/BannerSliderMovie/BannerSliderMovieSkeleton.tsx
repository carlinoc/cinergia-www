export default function BannerSliderMovieSkeleton() {
  return (
        ...
        <div className="flex flex-col justify-center gap-8 w-11/12 md:w-10/12">
          <div className="flex flex-col gap-4 w-full">
            <div className="w-full">
              <div className="w-44 h-10 rounded-md bg-dark-700" />

              <div className="w-96 h-12 mt-16 rounded-md bg-dark-700" />
            </div>

            <div className="max-w-prose h-6 rounded-md bg-dark-700" />
            <div className="max-w-prose h-6 rounded-md bg-dark-700" />
